...
export function RegisterStaffPage() {
  ...
  async function onSubmit() {
    ...
    toast.success('Staff account created. Await admin approval before signing in.')
  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground flex flex-col items-center p-4 sm:p-6 lg:p-10 overflow-hidden">
      {/* Ambient background glow — matches the role-selection page */}
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1080px]">
        ...
        <div className="mx-auto w-full max-w-[560px]">
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-primary/10 border border-primary/20 text-[11px] font-semibold text-primary backdrop-blur-sm">
              <Sparkles className="size-3.5 text-primary" />
              Staff &amp; Clinician Registration
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            ...
            <p className="mt-3 text-xs sm:text-sm font-medium text-muted-foreground leading-relaxed max-w-sm mx-auto">
              Connect with your campus health team. Enter your staff credentials and clinical role to
              get started.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-3xl bg-card p-7 sm:p-8 shadow-lg border border-border/80">
            ...
            <p className="mt-0 text-center text-xs sm:text-sm text-muted-foreground">
              Please fill out your verified campus medical centre details.
            </p>
            ...
            <form noValidate onSubmit={handleSubmit(onSubmit)} className="mt-6 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <select
                    id="clinicalRole"
                    aria-invalid={!!errors.clinicalRole}
                    aria-describedby={errors.clinicalRole ? 'role-error' : undefined}
                    defaultValue=""
                    className="h-12 w-full appearance-none rounded-xl border-0 bg-muted pl-11 pr-10 text-sm font-medium text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    {...register('clinicalRole')}
                  >
                    <option value="" disabled className="text-muted-foreground">
                      Select your clinical role…
                    </option>
                    {CLINICAL_ROLE_OPTIONS.map((opt) => (
                ...
                {errors.clinicalRole && (
                  <p id="role-error" role="alert" className="text-xs font-medium text-destructive">
                    {errors.clinicalRole.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder={`name.clinic@${UNIVERSITY_DOMAIN}`}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="Enter strong staff password"
          ...
          <p className="mt-6 flex items-center justify-center gap-1.5 text-xs text-muted-foreground">
            ...
            Secured via University of Moratuwa Health Information Registry &amp; Medical Board
          </p>
        </div>
      </div>
    </main>
