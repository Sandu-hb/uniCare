...
{
    /// <inheritdoc />
    public partial class AddIdentityAuthAndDocumentTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalDocument_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawText = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    ExtractedFieldsJson = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    OverallConfidence = table.Column<decimal>(type: "numeric(6,2)", precision: 6, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentExtraction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentExtraction_MedicalDocument_MedicalDocumentId",
                        column: x => x.MedicalDocumentId,
                        principalTable: "MedicalDocument",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentExtraction_MedicalDocumentId",
                table: "DocumentExtraction",
                column: "MedicalDocumentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MedicalDocument_StudentId",
